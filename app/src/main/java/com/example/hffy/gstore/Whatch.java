...
public class Whatch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        slider4.image(R.drawable.wathhua);
        ...
        items.add(new Item(4,123, "Intex irits", "Smart Watch de precio mas economico con sistema operativo android", R.drawable.watchintex,"E0zYOKgTZxQ", R.drawable.latecgrande,"El dispositivo INTEX iRist Watchphone mejorará tu forma de vida y la manera de disfrutar, de la más avanzada tecnología. Un concepto tecnológico totalmente nuevo, todo un sueño, que INTEX ha hecho realidad para que lo tengas todo, por muy poco."));
        items.add(new Item(5,123, "Huawei", "Smart watch huawei que  utiliza android", R.drawable.iwhamswan,"nVo00EvNd7Q", R.drawable.wathhua,"Clásico por fuera. Inteligente por dentro. Así es el Huawei Watch Classic, un reloj inteligente que te permitirá gestionar tu día a día desde la muñeca. Desde coger llamadas hasta contestar sms, escuchar música, consultar los resultados de tu actividad física diaria y mucho más."));
