...
public class Ps extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item(1,123, "Gran Turismo Sport", " ", R.drawable.granturismo1,"tj1qCxGH6Kg", R.drawable.granturismo2,"Is an upcoming racing video game developed by Polyphony Digital and published by Sony Interactive Entertainment for the PlayStation 4 video game console.\n" +
