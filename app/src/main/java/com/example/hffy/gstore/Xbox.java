...
public class Xbox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item(1, "Ashen", "Ashen es un videojuego de supervivencia, combate y exploración de mundo abierto ", R.drawable.ashen," ", R.drawable.ashen1,"Ashen es un videojuego de supervivencia, combate y exploración de mundo abierto ambientado en un entorno de fantasía en desarrollo para la consola Xbox One.\n" +
                "\n" +
        ...
        items.add(new Item(2, "Below", "Below se muestra un videojuego de aventura desarrollado por Capybara Games", R.drawable.below," ", R.drawable.below1,"Below se muestra un videojuego de aventura desarrollado por Capybara Games. Será publicado por Microsoft Studios para Microsoft Windows y Xbox One.\n" +
                "\n" +
        ...
        items.add(new Item(3, "BrambleLash", "Este es un videojuego que cuenta con una propuesta muy interesante.", R.drawable.bramblelash," ", R.drawable.bramblelash1,"BrambleLash está siendo desarrollado por el estudio independiente Byte Sprite Games y saldrá a la venta a principios de 2017 en Steam para PC y en consola saldrá de forma exclusiva para Xbox One. Este es un videojuego que cuenta con una propuesta muy interesante.\n" +
        ...
        items.add(new Item(4, "Crackdown 3", "Crackdown 3 es un videojuego de acción y aventura abierto ", R.drawable.crackdown1," ", R.drawable.crackdown2,"Crackdown 3 es un videojuego de acción y aventura abierto para Microsoft Windows y Xbox One con desarrollo dirigido por el desarrollador británico Reagent Games, un estudio dirigido por David Jones, director de Realtime Worlds y publicado por Microsoft Studios.\n" +
                "\n" +
