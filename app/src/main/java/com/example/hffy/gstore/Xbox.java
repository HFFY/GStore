...
public class Xbox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new Item(2,80, "Below", "Below se muestra un videojuego de aventura desarrollado por Capybara Games", R.drawable.below,"yARUhqPCjAw", R.drawable.below1,"Below se muestra un videojuego de aventura desarrollado por Capybara Games. Será publicado por Microsoft Studios para Microsoft Windows y Xbox One.\n" +
                "\n" +
